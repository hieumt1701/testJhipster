...
public class BookResource {
    ...
    public ResponseEntity<Book> partialUpdateBook(@PathVariable(value = "id", required = false) final Long id, @RequestBody Book book)
        ...
        Optional<Book> result = bookRepository
            ...
            .map(
                existingBook -> {
                    if (book.getTilte() != null) {
                        existingBook.setTilte(book.getTilte());
                    }
                    if (book.getDes() != null) {
                    ...
                    if (book.getImageContentType() != null) {
                        existingBook.setImageContentType(book.getImageContentType());
                    }
                    if (book.getDob() != null) {
                        existingBook.setDob(book.getDob());
                    }
                    if (book.getCv() != null) {
                        existingBook.setCv(book.getCv());
                    }
                    if (book.getCvContentType() != null) {
                        existingBook.setCvContentType(book.getCvContentType());
                    }
